...
<body>
    <div class="page-wrapper bg-gra-01 p-t-100 p-b-50 font-poppins">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="proses/register.php">
                        <div class="input-group"> 
                            <input class="input--style-3" type="text" placeholder="Name" name="nama" require>
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="email" placeholder="Email" name="email" require>
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Username" name="username" require>
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Password" name="pass" require>
                        </div>
                        <div class="p-t-10">
