...
$id = $_GET['id'];
$sql = " SELECT * FROM baju WHERE id_baju = '$id'";
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row">
            <form action="proses/edit_func.php" method="POST" class="form-style-1">
                <ul>
                    <li>
                    ...
                    <li>
                        <label>Stock</label><input type="text" name="stock" value="<?= $data['stock']?>" class="field-long">
                    </li>
                    <li>
                        <label>Harga Satuan :</label><input type="text" name="harga" value="<?= $data['harga']?>" class="field-long">
                    </li>
                    <li>
