        ...
        <div class="row">
            <form action="proses/edit_func.php" method="POST" class="form-style-1" enctype="multipart/form-data">
                <ul>
                    ...
                    <li>
                        <label>Harga</label><input type="text" name="harga" value="<?= $data['harga']?>" class="field-long">
                    </li>
                    <li>
                        <label>Stock</label><input type="text" name="stock" value="<?= $data['stok']?>" class="field-long">
                    </li>
                    <li>
                        <label>File Gambar</label><input type="file" name="file" value="<?= $data['gambar']?>" class="field-long">
                    </li>
                    <li>
