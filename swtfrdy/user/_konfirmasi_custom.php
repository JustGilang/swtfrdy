    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
          <div class="row">
            <form action="proses/add_func.php?act=add_trans_custom" method="POST" class="form-style-1" enctype="multipart/form-data">
              <?php
              $sql = mysqli_query($conn, "SELECT * FROM custom WHERE id_member='$id' AND id_custom='$_GET[id]'");
              $data = mysqli_fetch_array($sql);
              ?>
                <ul>
                    <li>
                    ...
                    <li>
                        <label>ID Custom</label><input type="text" name="id_custom" value="<?= $data['id_custom']?>" class="field-long" readonly>
                    </li>
                    <li>
